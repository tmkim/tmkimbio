...
const ResumePage = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 m-6 rounded-xl text-black">
      {/* Header Section */}
        ...
        <div className="mb-4">
          ...
          <ul className="list-disc list-inside">
            ...
            <li>
              ...
              className="font-semibold text-blue-700">Dank Bank</Link>: Catalog of personal experiences to share my recommendations with the world
            </li>
            <li>
              <Link href="https://www.github.com/tmkim/bountyhunter"
              className="font-semibold text-blue-700">Bounty Hunter</Link>: One Piece TCG deck builder and price tracker 
            </li>
            <li>
              <Link href="https://www.github.com/tmkim/mle-basic"
              className="font-semibold text-blue-700">T-Planet</Link>: Bare-bones study platform with customizable exam options
            </li>
          </ul>
        </div>
      ...
      <section className="mb-8">
        ...
        <div className="mb-4">
          ...
          <ul className="list-disc list-inside">
            ...
            <li>
              Built interactive web applications to support student learning and track progress
            </li>
          </ul>
        </div>
      </section>
